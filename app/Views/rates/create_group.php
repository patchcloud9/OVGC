...
<!-- hero for creating rate group -->
<section class="hero is-dark subpage-hero is-small">
    <div class="hero-body">
        <div class="container">
            <h1 class="title is-3"><i class="fas fa-plus"></i> Create Rate Group</h1>
            <p class="subtitle is-6 has-text-white">Add a new group</p>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container" style="max-width:1000px;">
        ...
        <h1 class="title">Create Rate Group</h1>
