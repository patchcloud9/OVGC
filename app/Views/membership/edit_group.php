...
<!-- hero for editing membership group -->
<section class="hero is-dark subpage-hero is-small">
    <div class="hero-body">
        <div class="container">
            <h1 class="title is-3"><i class="fas fa-users"></i> Edit Membership Group</h1>
...
<section class="section">
    <div class="container" style="max-width:1000px;">
        ...
        <form method="POST" action="/admin/membership/<?= e($group['id']) ?>" style="max-width:600px;">
            <?= csrf_field() ?>
