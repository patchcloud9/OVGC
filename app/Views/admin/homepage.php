        ...
        <form method="POST" action="/admin/homepage" enctype="multipart/form-data">
            ...
            <div class="box mt-5">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <label class="radio">
                            <input type="radio" name="camera2_mode" value="live" <?= ($settings['camera2_mode'] ?? 'maintenance') === 'live' ? 'checked' : '' ?>>
                            Live Camera (auto-refreshing feed)
                        </label>
                        <label class="radio ml-4">
...
<script src="/assets/js/admin-homepage.js?v=<?= @filemtime(BASE_PATH . '/public/assets/js/admin-homepage.js') ?>"></script>
