                            ...
                            <div class="card-image">
                                <figure class="image gallery-image-container">
                                    <a href="#" class="gallery-open"
                                       ...
                                       data-theme-email="<?= e(\App\Models\ThemeSetting::get('contact_email', '')) ?>">
                                    ...
                                    <?php if (isset($image['price_type']) && $image['price_type'] !== 'hide'): ?>
                                        <div class="mt-3">
                                            <?php if ($image['price_type'] === 'amount' && !empty($image['price_amount'])): ?>
                                                ...
                                                <?php $themeEmail = \App\Models\ThemeSetting::get('contact_email', ''); if (!empty($themeEmail)): ?>
...
<script src="/assets/js/gallery-lightbox.js?v=<?= @filemtime(BASE_PATH . '/public/assets/js/gallery-lightbox.js') ?>"></script>
